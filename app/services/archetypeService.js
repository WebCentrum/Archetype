    ...
    return {
        ...
        validateProperty: function (fieldset, property, configFieldsetModel) {
            ...
            if (propertyConfig) {
                ...
                if (propertyConfig.required && (property.value == null || property.value === "" || property.value !== property.value || Array.isArray(property.value) && property.value.length == 0)) {
        ...
        propertyValueChanged: function (fieldset, property, isValid) {
